...
public class OfertaLaboralPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "OfertaLaboral";
	...
	private OfertaLaboralPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new OfertaLaboralPersistentManager();
		}
